...
/***/ function(module, exports, __webpack_require__) {
	...
	var Helper = (function () {
	    ...
	    _createClass(Helper, [{
	        ...
	        key: 'round',
	        value: function round(_ref2) {
	            var value = _ref2.value;
	            var _ref2$decimalPlace = _ref2.decimalPlace;
	            var decimalPlace = _ref2$decimalPlace === undefined ? 1 : _ref2$decimalPlace;
	
	            var round = '1';
	
	            for (var i = 0; i < decimalPlace; i += 1) {
	                round += '0';
	        ...
	        key: 'findPercentage',
	        value: function findPercentage(_ref3) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Background = (function () {
	    ...
	    _createClass(Background, [{
	        ...
	        key: 'generateStop',
	        value: function generateStop() {
	
	            // Randomises a hsla color based on the given parameters on
	            // initialisation.
	
	            var hue = this.randomiseHue();
	            var saturation = this.randomiseSaturation();
	            var luminosity = this.randomiseLuminosity();
	            var alpha = this.randomiseAlpha();
	
	            return { hue: hue, saturation: saturation, luminosity: luminosity, alpha: alpha };
	        }
	    }, {
	        key: 'build',
	        ...
	        value: function createGradient() {
	            ...
	            try {
	                for (var _iterator = this.stops[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	                    var _stop = _step.value;
	
	                    var hsl = this.produceHsl(_stop);
	                    grad.addColorStop(_stop.x, hsl);
	                }
	            } catch (err) {
	        ...
	        value: function reorderStops() {
	            ...
	            for (var i = 0; i < 3; i += 1) {
	                ...
	                var _stop2 = this.stops[i - 1] || this.generateStop();
	                reorder[i] = _stop2;
	        ...
	        key: 'randomiseHue',
	        value: function randomiseHue() {
	
	            var properties = this.properties.hue || {};
	        ...
	        key: 'randomiseSaturation',
	        value: function randomiseSaturation() {
	
	            var properties = this.properties.saturation || {};
	        ...
	        key: 'randomiseLuminosity',
	        value: function randomiseLuminosity() {
	
	            var properties = this.properties.luminosity || {};
	        ...
	        key: 'randomiseAlpha',
	        value: function randomiseAlpha() {
	
	            var properties = this.properties.alpha || {};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Glare = (function () {
	    ...
	    _createClass(Glare, [{
	        ...
	        key: 'calculateFrequecy',
	        value: function calculateFrequecy() {
	        ...
	        value: function calculateDepreciation() {
	        ...
	        key: 'queryDistruction',
	        value: function queryDistruction() {
